 ...
 * @returns {any}
 */
function createCreature(species_id, options) {
 ...
 * @returns {any}
 */
function getBestMoveMCTS(state, player_id, iterations) {
...
exports.getBestMoveMCTS = getBestMoveMCTS;
 ...
 * @returns {any}
 */
function getBestMoveMinimax(state, player_id, depth) {
    const ptr0 = passStringToWasm0(player_id, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
...
exports.getBestMoveMinimax = getBestMoveMinimax;
...
exports.isBattleOver = isBattleOver;
 ...
 * @returns {any}
 */
function stepBattle(state, actions, options) {
...
const wasmPath = `${__dirname}/engine_rust_bg.wasm`;
